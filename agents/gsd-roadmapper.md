...
Reference full template: `/Users/phillipdougherty/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/phillipdougherty/.claude/get-shit-done/templates/state.md`.
