...
Four opinionated reference documents are generated per project and referenced throughout the development lifecycle:
...
- **Referenced** by planners and executors during every phase
...
|--------------|-------------|--------------|
| **Project Init** | PROJECT.md, REQUIREMENTS.md, ROADMAP.md | + SECURITY.md, APIS.md, TESTING-STRATEGY.md, ERROR-HANDLING.md |
